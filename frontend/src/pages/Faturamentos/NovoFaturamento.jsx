...
function NovoFaturamento({ onNavigate }) {
  return (
    <div className="form-page form-page-wide">
      <PageHeader title="Novo lançamento" description="Registre o faturamento mensal e os estoques de uma empresa." />
      <section className="form-card" aria-labelledby="faturamento-form-title">
        ...
        <div className="form-card-body"><FaturamentoForm onCancel={() => onNavigate('faturamentos')} /></div>
      </section>
    </div>
  )
}
